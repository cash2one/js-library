...
define(function(require) {
    ...
    function copyParams(target, source) {
        for (var item in source) {
            target[item] = (typeof source[item] == 'function')
     ...
     * @param {string} opt_target The target of this log request.
     * @param {boolean} opt_onlyUseBasicParams If true, exclude extra params.
     *
     * @return {string} empty by default, or the form that send the real request
     *     in debug mode.
     */
    logger.log = function(params, opt_target, opt_onlyUseBasicParams) {
